...
<body>
    <div id="contentWrapper">
            <div id="logo"></div>
            <div class="centralLoginText"><h2>Unlocked Registration</h2></div>
            <div id="formWrapper">
                <form id="login" onsubmit="return false;">
                    ...
                    <input id="signupBtn" type="submit" value="Create Account" onclick="signup()">
                </form>
                <div class="registerText">
                    <p id="bottomPageMargin">Already have an account? <a href="login.php">Login Here</a></p>
                </div>
            </div>
        </div>
